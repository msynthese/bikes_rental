...
bike_m1 = { name: "Scott Genius 740", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 80, description: default_descr, address: "Eschenweg 22, 8057 Geneve  Switzerland", user: User.second, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/enduro-genius-740-mtb-bcyclet-reduite-2.jpg" }
bike_m2 = { name: "Scott Gambler 720", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "Rue Chantepoulet 22, 1201 Geneve  Switzerland", user: User.second, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/gambler-720-bcyclet-rental-mtb-downhill-reduite.jpg" }
bike_m3 = { name: "BMC Black", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 150, description: default_descr, address: "Bündenackerstrasse 27, 3097 Lausanne  Switzerland", user: User.second, picture_url: "https://www.bmc-switzerland.com/media/catalog/product/cache/86a9a13297e2ff4b2d593e234876b106/b/m/bmc-22-10515-006-bmc-twostroke-01-two-mountain-bike-anthracite-01.png" }
bike_m4 = { name: "BMC Red", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 180, description: default_descr, address: "Nesslerenholzweg 28, 3084 Lausanne  Switzerland", user: User.second, picture_url: "https://www.bmc-switzerland.com/media/catalog/product/cache/86a9a13297e2ff4b2d593e234876b106/b/m/bmc-22-10515-008-bmc-twostroke-01-four-mountain-bike-red-01.png" }
bike_m5 = { name: "BMC Grey", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 190, description: default_descr, address: "Eigerplatz 27, 3600 Lausanne  Switzerland", user: User.second, picture_url: "https://media.alltricks.com/large/209103960d188b7a086f5.50729917.jpg" }
bike_m6 = { name: "BMC Blue", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 120, description: default_descr, address: "Probsteistrasse 4, 8051 Lausanne  Switzerland", user: User.second, picture_url: "https://media.alltricks.com/medium/2127663614de9588cfb81.39705209.jpg" }
bike_m7 = { name: "BMC Green", category: Bike.categories[:mountain], size: Bike.sizes[:adult], price: 140, description: default_descr, address: "Lochgutweg 22, 3095 Lausanne  Switzerland", user: User.second, picture_url: "https://media.alltricks.com/medium/2134104614457709e9912.47404173.jpg" }

bike_e1 = { name: "Scott E-sub Men", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 75, description: default_descr, address: "Frymannstrasse 20, 8041 Geneve  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/scott-eride-10-bcyclet-rental-electric-trekking-rate.jpg" }
bike_e2 = { name: "Scott E-sub Unisex", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 75, description: default_descr, address: "Schweigmatt 5, 8055 Geneve  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/scott-eride-10-lady-bcyclet-rental-electric-trekking-1.jpg" }
bike_e3 = { name: "Scott E-silence speed", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "Adrien-Wyss 22, 1235 Lausanne  Switzerland", user: User.second, picture_url: "https://bcyclet.com/wp-content/uploads/2021/10/scott-electric-trekking-45-bike-rental-bcyclet-reduite-1.jpg" }
bike_e4 = { name: "Scott E-Genius", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "Schneerütiweg 14, 8405 Lausanne  Switzerland", user: User.second, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/scott-eride-720-bcyclet-rental-mtb-electric-full-suspension-reduite.jpg" }
bike_e5 = { name: "Scott E-Scale", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 75, description: default_descr, address: "Nesslerenweg 23, 3084 Lausanne  Switzerland", user: User.third, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/E-Scale-MTB-Bcyclet-HQ-2.jpg" }
bike_e6 = { name: "Road Orbea E-Bike", category: Bike.categories[:electric], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "Finkenhubelweg 26, 3012 Lausanne  Switzerland", user: User.third, picture_url: "https://bcyclet.com/wp-content/uploads/2019/09/E-road-bike.png" }

bike_j1 = { name: "Scott Red Junior", category: Bike.categories[:mountain], size: Bike.sizes[:junior], price: 20, description: default_descr, address: "Wiler 31, 3608 Geneve  Switzerland", user: User.third, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/Junior-bike-Bcyclet-HQ-2.jpg" }
