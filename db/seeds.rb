...
bike_r1 = { name: "scott white", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 55, description: default_descr, address: "Rue Voltaire 12, 1210 Geneve", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/Solace-20-2016-Bcyclet-1.jpg" }
bike_r2 = { name: "scott grey/yellow", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 75, description: default_descr, address: "avenue de France 23, 1004 Lausanne  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2020/01/Solace-premium-pads-1.jpg" }
bike_r3 = { name: "scott white premium", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 75, description: default_descr, address: "avenue de France 23, 1004 Lausanne  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/Addict-Premium-disc-Bcyclet-HQ-2.jpg" }
bike_r4 = { name: "scott black", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "avenue de France 23, 1004 Lausanne Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2020/01/scott-addict-ultimate-disc-bcyclet-rental-road-bike-reduite.jpg" }
bike_r5 = { name: "scott yellow", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "avenue de France 23, 1004 Lausanne Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/scott-addict-bcyclet-rental-road-bike-reduite.jpg" }
bike_r6 = { name: "scott black/red", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 125, description: default_descr, address: "Rue Voltaire 12, 1210 Geneve  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2020/01/bcyclet-ultimate-pads-super-light-bike-rental-1.jpg" }
bike_r7 = { name: "scott red", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 100, description: default_descr, address: "Rue Voltaire 12, 1210 Geneve  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2020/01/electric-road-bike-orbea-gain-low.jpg" }
bike_r8 = { name: "prestige racing", category: Bike.categories[:road], size: Bike.sizes[:adult], price: 175, description: default_descr, address: "Rue Voltaire 12, 1210 Geneve  Switzerland", user: User.first, picture_url: "https://bcyclet.com/wp-content/uploads/2019/11/Lampo-M.jpg" }
